...
<template>
  <SearchLayout page="search">
    ...
    <div class="p-1 md:p-2 pb-28 md:pb-2 flex flex-col gap-4" v-if="activeTab === 'search'">
      <CourseCard
    ...
    <div class="p-1 md:p-2 pb-28 md:pb-2 flex flex-col gap-4" v-else-if="activeTab === 'selected'">
